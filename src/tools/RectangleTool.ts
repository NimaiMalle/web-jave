...
import { rectangleOutline, setPixel } from '../utils/geometry.js';
...
export class RectangleTool extends BaseTool {
  ...
  onMouseMove(e: CanvasMouseEvent, doc: Document, callbacks: ToolCallbacks): void {
    ...
    for (const pt of rectangleOutline(this.startX, this.startY, this.endX, this.endY)) {
  ...
  onMouseUp(_e: CanvasMouseEvent, doc: Document, callbacks: ToolCallbacks): void {
    ...
    // Commit rectangle to pixel canvas and track drawn pixels
